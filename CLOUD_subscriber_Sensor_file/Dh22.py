...
try:
  mycursor.execute("CREATE TABLE TempHumid (timestamp VARCHAR(50),Room_Temperature FLOAT(20),Room_Humidity FLOAT(20))")
except mysql.connector.Error as err:
  print("Something went wrong: {}".format(err))
topic_name = "TEMPERATURE1"
qos = 1
...
def on_message(client, userdata, msg):
    ...
    x=temp.split(",")
    mycursor.execute("INSERT INTO TempHumid VALUES(%s,%s,%s)",(d,x[0],x[1]))
