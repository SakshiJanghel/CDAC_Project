...
try:
  mycursor.execute("CREATE TABLE PulseData (timestamp VARCHAR(50),PULSE_RATE FLOAT(20),OXYGEN_RATE FLOAT(20))")
except mysql.connector.Error as err:
  print("Something went wrong: {}".format(err))
topic_name ="BPM_SPO2"
qos = 1
...
def on_message(client, userdata, msg):
    ...
    x=temp.split(",")
    mycursor.execute("INSERT INTO PulseData VALUES(%s,%s,%s)",(d,x[0],x[1]))
